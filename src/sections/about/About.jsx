      ...
      <div className="container about__container">
        ...
        <div className="about__right">
          ...
          <p>
            ...
            in the web development industry for over 4 years and serving more
            than 70 happy clients worldwide, I'm always motivated to do more!
          </p>
          <p>
            Hi, my name is Hartman Mandor from Akwa Ibom, Nigeria. I'm a
            front-end web developer with a Bachelors degree in Computer
            Engineering. My top priority is to get your business online the
